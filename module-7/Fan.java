 ...
 *
 * Description:
 * This class represents a Fan object with speed, on/off state, radius, and color properties.
 * It provides constants, constructors, validation, getters, setters, and a string representation.
 * The class uses the this reference where appropriate to distinguish and access instance members.
 */
...
public class Fan {
    ...
    public String toString() {
        if (this.on && this.speed == SLOW) {
            return "The " + this.color + " fan is on. Speed is SLOW. Radius is " + this.radius + ".\n";
        } else if (this.on && this.speed == MEDIUM) {
            return "The " + this.color + " fan is on. Speed is MEDIUM. Radius is " + this.radius + ".\n";
        } else if (this.on && this.speed == FAST) {
            return "The " + this.color + " fan is on. Speed is FAST. Radius is " + this.radius + ".\n";
        } else {
            return "The " + this.color + " fan is off. Radius is " + this.radius + ".\n";
        }
    }
} 
